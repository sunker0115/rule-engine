...
public record MetricDescriptor(
    ...
    public MetricDescriptor(String metricCode, String sourceType, String dataType,
        ...
        this(metricCode, 1, sourceType, dataType, allowProvided, cacheTtlSeconds, params, null, null, null, null, null);
    }

    /** 兼容旧调用点的便利构造：使用旧 7 字段签名（新增 name/status/createdAt/updatedAt/tenantId 填 null）。 */
