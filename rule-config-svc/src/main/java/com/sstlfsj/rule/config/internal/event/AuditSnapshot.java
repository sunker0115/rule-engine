...
public sealed interface AuditSnapshot
        permits DraftCreatedSnapshot, RulePublishedSnapshot, RuleStatusSnapshot, RuleImportedSnapshot, MetricChangedSnapshot, SceneSnapshot, ConnectorChangedSnapshot {
}
