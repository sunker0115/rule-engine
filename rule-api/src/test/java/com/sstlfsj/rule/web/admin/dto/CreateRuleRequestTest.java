...
class CreateRuleRequestTest {
    ...
    void bindsTypedBody() {
        ...
        assertThat(req.body()).isInstanceOf(AstBody.class);
        assertThat(((AstBody) req.body()).conditionAst()).isInstanceOf(AndNode.class);
    ...
    void decisionBindingsSerializeBackToSameShape() {
        CreateRuleRequest req = new CreateRuleRequest(
                ...
                new AstBody(new AndNode(java.util.List.of(), null, null)),
    ...
    void bindsScriptBody() {
        // EXPRESSION_SCRIPT 规则：body 为 ScriptBody
        String json = """
