...
/** 验证 AuditAutoConfiguration 能正确注册 AuditService / EffectivenessService bean。 */
class AuditAutoConfigurationTest {

    // 注入 Mapper mock，满足 AuditServiceImpl / EffectivenessServiceImpl 的构造器依赖
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            ...
            .withBean(EffectivenessReadMapper.class, () -> mock(EffectivenessReadMapper.class))
    ...
    @Test
    void effectivenessService_bean已注册() {
        contextRunner.run(ctx -> assertThat(ctx).hasSingleBean(EffectivenessService.class));
    }
}
